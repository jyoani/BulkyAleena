...
namespace BulkyProject.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderId)
        {
            ...
            {
                // Log the exception
                ModelState.AddModelError(string.Empty, "An error occurred while retrieving order details.");
                return View(new OrderVM()); // Return an empty view model
            }
        }
        ...
        public IActionResult UpdateOrderDetail()
        {
            ...
            {
                // Log the exception
                ModelState.AddModelError(string.Empty, "An error occurred while updating order details.");
                return View(OrderVM);
            }
        }
        ...
        public IActionResult StartProcessing()
        {
            ...
            {
                // Log the exception
                ModelState.AddModelError(string.Empty, "An error occurred while updating order status.");
                return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
            }
        }
        ...
        public IActionResult ShipOrder()
        {
            ...
            {
                // Log the exception
                ModelState.AddModelError(string.Empty, "An error occurred while shipping the order.");
                return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
            }
        }
        ...
        public IActionResult CancelOrder()
        {
            ...
            {
                // Log the exception
                ModelState.AddModelError(string.Empty, "An error occurred while canceling the order.");
                return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
            }
        }
        ...
        public IActionResult PaymentConfirmation(int orderHeaderId)
        {
            ...
            {
                // Log the exception
                ModelState.AddModelError(string.Empty, "An error occurred while confirming the payment.");
                return View(orderHeaderId);
            }
        }
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                // Log the exception
                return Json(new { success = false, message = "An error occurred while retrieving orders." });
            }
        }
